...
<div align=center class="panel-heading">新規メモ追加ページ</div>
...
<div class="col-md-6">
<textarea id="content" type="text" rows="3" class="form-control" name="content" required autofocus>{{ old('content') }}</textarea>
</div>
</div>
<div class="form-group">
